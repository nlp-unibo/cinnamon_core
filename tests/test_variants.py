...
def test_flatten_parameter_variants(
    ...
    variant_keys = Registry.register_and_bind_configuration_variants(configuration_class=ParentConfig,
                                                                     component_class=Component,
                                                                     name='parent',
                                                                     namespace='testing',
...
def test_nested_parameter_variants(
    ...
    variant_keys = Registry.register_and_bind_configuration_variants(configuration_class=ConfigA,
                                                                     component_class=Component,
                                                                     name='config_a',
                                                                     namespace='testing',
                                                                     parameter_variants_only=True)
...
def test_nested_configuration_variants_with_allow_2(
    ...
    variant_keys = Registry.register_and_bind_configuration_variants(configuration_class=ConfigD,
                                                                     component_class=Component,
                                                                     name='config_d',
                                                                     namespace='testing',
                                                                     parameter_variants_only=False,
...
def test_variants_with_conditions(
    ...
    variant_keys = Registry.register_and_bind_configuration_variants(configuration_class=ConfigF,
                                                                     component_class=Component,
                                                                     name='config_f',
                                                                     namespace='testing',
                                                                     parameter_variants_only=True)
